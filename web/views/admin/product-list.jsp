...
<head>
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box;}
    ...
    h1{font-size:1.4rem;font-weight:700;color:#f0f0f0;margin-bottom:1.5rem;}
    .toolbar{display:flex;justify-content:space-between;align-items:center;margin-bottom:1.2rem;}
    .btn-add{background:#f97316;color:#fff;padding:.55rem 1.2rem;border-radius:8px;
      text-decoration:none;font-weight:600;font-size:.9rem;}
    .msg{background:#14532d;border:1px solid #166534;color:#86efac;
    ...
    th{background:#222;color:#777;font-size:.75rem;text-transform:uppercase;
      letter-spacing:.5px;padding:.65rem 1rem;text-align:left;}
    td{padding:.75rem 1rem;border-bottom:1px solid #1f1f1f;font-size:.87rem;}
    tr:last-child td{border:none;}
    .price{color:#f97316;font-weight:700;}
    .active-badge{background:#14532d;color:#86efac;padding:.18rem .5rem;border-radius:12px;font-size:.72rem;}
    .inactive-badge{background:#3b1a1a;color:#f87171;padding:.18rem .5rem;border-radius:12px;font-size:.72rem;}
    .featured-badge{background:#2d1800;color:#fb923c;padding:.18rem .5rem;border-radius:12px;font-size:.72rem;}
    .actions a{color:#60a5fa;font-size:.83rem;text-decoration:none;margin-right:.6rem;}
    .actions a.del{color:#f87171;}
    .actions a:hover{text-decoration:underline;}
    img.thumb{width:44px;height:44px;border-radius:8px;object-fit:cover;background:#141414;}
  </style>
</head>
<body>
<div class="sidebar">
...
<div class="main">
  ...
  <table>
    <thead>
      <tr>
        <th>Ảnh</th><th>#</th><th>Tên món</th><th>Danh mục</th>
        ...
        <tr>
          ...
          <td class="actions">
            ...
            <a href="${pageContext.request.contextPath}/admin/products?action=delete&id=${p.productID}"
               class="del"
               onclick="return confirm('Ẩn món này?')">🗑 Ẩn</a>
          </td>
        </tr>
      </c:forEach>
    </tbody>
