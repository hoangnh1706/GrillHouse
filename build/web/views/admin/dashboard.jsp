...
<head>
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box;}
    ...
    .welcome h1{font-size:1.6rem;font-weight:700;color:#f0f0f0;}
    .welcome p{color:#666;margin-top:.3rem;}
    ...
    .stat-value{font-size:2rem;font-weight:800;color:#f97316;}
    .stat-note{font-size:.78rem;color:#555;}

    h2{font-size:1.1rem;font-weight:700;color:#f0f0f0;margin-bottom:1rem;}
    table{width:100%;border-collapse:collapse;background:#1a1a1a;border-radius:12px;overflow:hidden;}
    th{background:#222;color:#888;font-size:.78rem;text-transform:uppercase;letter-spacing:.5px;padding:.65rem 1rem;text-align:left;}
    td{padding:.75rem 1rem;border-bottom:1px solid #1f1f1f;font-size:.88rem;}
    tr:last-child td{border:none;}
    .price{color:#f97316;font-weight:700;}
    .status{padding:.22rem .6rem;border-radius:12px;font-size:.74rem;font-weight:700;}
...
<div class="main">
  ...
  <div class="stats">
    ...
    <div class="stat-card">
      ...
      <div class="stat-note"><a href="${pageContext.request.contextPath}/admin/orders?status=0" style="color:#f97316;">Xem ngay →</a></div>
    </div>
    <div class="stat-card">
      <div class="stat-icon">📦</div>
    ...
    <tbody>
      <c:forEach var="o" items="${recentOrders}">
        <tr>
          ...
          <td style="color:#777;"><fmt:formatDate value="${o.orderDate}" pattern="dd/MM HH:mm"/></td>
          <td class="price"><fmt:formatNumber value="${o.finalAmount}" pattern="#,###"/>đ</td>
