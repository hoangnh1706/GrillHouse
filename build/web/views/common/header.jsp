    ...
    <div id="chat-window">
      <div class="cw-head">
        <div class="cw-head-left">
          ...
          <div>
            <div class="cw-title">Chef Bếp Nướng AI</div>
        ...
        window.toggleChat = function () {
          ...
          if (isOpen && !greeted) {
            ...
            setTimeout(() => {
              ...
              addMsg('bot', '👋 Xin chào <b>' + name + '</b>! Mình là <b>Chef AI</b> của Bếp Nướng 🔥<br>Mình có thể tư vấn món ăn, combo, chính sách giao hàng và tra cứu đơn hàng cho bạn. Bạn cần hỗ trợ gì?');
            }, 300);
          }
        };
